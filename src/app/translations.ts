export const de = {
  ...
  areaLabelHeader: "Witty Works Navigation",
  wittyIconAlt: "Witty Works Icon",
  sadFaceIconAlt: "",
  starIconAlt: "",
  ...
  quickSettings: "Schnell-Einstellungen",
  ...
  notSignedInWarning:
    "Witty konnte dich nicht authentifizieren. Stelle sicher, dass Du in Microsoft Word angemeldet bist. Sobald Du angemeldet bist, schließe bitte das Witty for Word Add-In und öffnen es erneut.",
  serverError:
  ...
  notSupportedAccount: "Dein Konto wird von Microsoft nicht unterstützt. Bitte kontaktiere den Witty Support.",
...
export const en = {
  ...
  notSignedInWarning:
    "Witty could not authenticate you, please make sure you are signed into Word. Once you are signed in, please close and re-open the Witty for Word add-in.",
  serverError:
  ...
  notSupportedAccount: "Your account is not supported by Microsoft. Please contact Witty support.",
...
export const fr = {
  ...
  notSupportedAccount: "Votre compte n'est pas pris en charge par Microsoft. Veuillez contacter le support Witty.",
