export const de = {
    ...
    signUp: 'Registrieren',
    wittyCheck: 'Witty Prüfung',
    suggstions: 'Empfehlungen',
    clickWittyCheck: 'Wähle «Witty Prüfung, um Empfehlungen zu erhalten',
...
export const en = {
    ...
    signUp: 'Sign up',
    wittyCheck: 'Witty Check',
    suggstions: 'suggestions',
    clickWittyCheck: 'Choose «Witty Check», to get suggestions',
